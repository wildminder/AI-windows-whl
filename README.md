...
| Package Version | PyTorch Ver | Python Ver | CUDA Ver | Download Link |
|:---:|:---:|:---:|:---:|:---:|
| `0.0.33` | `>2.8` | `>3.9` | `130` | [Link](https://huggingface.co/Wildminder/AI-windows-whl/blob/main/xformers-0.0.33%2B00a7a5f0.d20251021-cp39-abi3-win_amd64.whl) |
...
| `0.0.32.post2` | `2.8` | `3.9` | `12.6` | [Link](https://download.pytorch.org/whl/cu126/xformers-0.0.32.post2-cp39-abi3-win_amd64.whl) |
<!-- END_XFORMERS_TABLE --> 
...
| `1.0.1` | `2.9` | `3.13` | [Link](https://huggingface.co/Wildminder/AI-windows-whl/blob/main/nunchaku-1.0.1%2Btorch2.9c128-cp313-cp313-win_amd64.whl) |
| `1.0.1` | `2.9` | `3.13` | [Link](https://huggingface.co/Wildminder/AI-windows-whl/blob/main/nunchaku-1.0.1%2Btorch2.9c130-cp313-cp313-win_amd64.whl) |
